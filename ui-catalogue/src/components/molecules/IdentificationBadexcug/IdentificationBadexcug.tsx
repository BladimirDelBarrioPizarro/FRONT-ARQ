...
import { IIdentificationBadexcug } from './types'
import {
  makeStyles,
  Grid
...
const IdentificationBadexcug: React.FC<IIdentificationBadexcug> = ({
  i18n,
  data
}) => {
              ...
              {[
                {
                  type: 'text',
                  name: 'nif',
                  label: i18n['Identification:nif'],
                  value: data.codigoEmpresa,
                  typeBis: 'text',
                  nameBis: 'localidad',
                  labelBis: i18n['Identification:localidad'],
