...
import { IMicrofinanceDebt } from './types'
import {
  makeStyles,
  Grid
...
const MicrofinanceDebt: React.FC<IMicrofinanceDebt> = ({
  i18n,
  data
}) => {
            ...
            <div className={classes.divContainer}>
              ...
              {[
                {
                  type: 'text',
                  name: 'ultimoPeriodo',
                  label: i18n['MicrofinanceDebt:ultimoPeriodo'],
                  value: data.ultimoPeriodo
                }
              ...
              {[
                {
                  type: 'text',
                  name: 'nroEntidades',
                  label: i18n['MicrofinanceDebt:nroEntidadesInput'],
                  value: data.nroEntidadesInput,
                  typeBis: 'text',
                  nameBis: 'peorCalificacion',
                  labelBis: i18n['MicrofinanceDebt:peorCalificacion'],
                  valueBis: data.peorCalificacion
                }
              ...
              <table className={classes.table}>
                ...
                <tr>
                  <td className={classes.contentTable}>
                    <span className={classes.labelStyle}>
                      {i18n['MicrofinanceDebt:nroEntidades']}
                    </span>
                  </td>
                  {[
                    {
                ...
                <tr>
                  <td className={classes.contentTable}>
                    <span className={classes.labelStyle}>
                      {i18n['MicrofinanceDebt:totalDeuda']}
                    </span>
                  </td>
                  {[
                    {
